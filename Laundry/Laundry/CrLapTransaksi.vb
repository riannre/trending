...
Public Class CrLapTransaksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laundry.CrLapTransaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrLapTransaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrLapTransaksi = New CrLapTransaksi()
        rpt.Site = Me.Site
        Return rpt
    End Function
